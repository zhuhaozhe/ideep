...
private:
  ...
  static void compute_impl_(const tensor& src,
    ...
    tensor expected_dst(pd.dst_desc());
...
struct inner_product_backward_data : public dnnl::inner_product_backward_data {
  ...
  static void compute(const tensor& diff_dst,
    ...
    tensor expected_diff_src(pd.diff_src_desc());
...
private:
  ...
  static void compute_impl(const tensor& src,
    ...
    tensor expected_diff_weights(pd.diff_weights_desc());
    ...
    if (with_diff_bias) {
      ...
      tensor expected_diff_bias(pd.diff_bias_desc());
